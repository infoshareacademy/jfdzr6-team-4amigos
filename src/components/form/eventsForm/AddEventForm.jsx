        ...
        <div>
            <form style={{ marginTop: "100px", }} onSubmit={handleSubmit(onSubmit)}>
                ...
                <div>
                    ...
                    <input name="city" {...register("city", { required: true, minLength: 4, maxLength: 20 })} />
                ...
                <div>
                    <label>Data</label>
                    <input type="date" name="date" {...register("startDate", { required: true })} />
                    {errors.startDate?.type === 'required' && "Miejsce jest wymagana"}
                </div>
                <div>
                    <label>Godzina</label>
                    <input type="time" name="time" {...register("startTime", { required: true })} />
                    {errors.startTime?.type === 'required' && "Godzina jest wymagana"}
                </div>
                <div>
                    <label>Opis wydarzenia</label>
                    <textarea name="description" {...register("description", { required: true, minLength: 4, maxLength: 100 })} />
